...
mongoose.connect("mongodb+srv://fonoha:<pw>@cluster0.9u7dm82.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
app.use(session({ // Inicio de sesion
    secret: "coderSecret", // Esta es la contraseña de la Cookie firmada.
    resave: true,
    saveUninitialized: true,
    store: MongoStore.create({
        mongoUrl: "mongodb+srv://fonoha:<pw>@cluster0.9u7dm82.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
